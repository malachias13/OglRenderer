...
#include "OpenGLCode/Camera.h"
#include "OpenGLCode/Shader.h"
...
// ---------------------------------------
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setFloat("light.linear", 0.0002);
        lightingShader.setFloat("light.quadratic", 0.0007);
        ...
        for (int i = 0; i < 400; i++)
        {
            glm::mat4 model = glm::mat4(1.0f); // Create a cube
            ...
            model = glm::translate(model, glm::vec3(-7.0f + x, -5.0f, -10.0f + z));
            lightingShader.setMat4("model", model);
